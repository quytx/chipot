...
g = i.prototype;
g.J = "http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/images/m";
g.I = "png";
...
g.B = f("A");
g.z = function(a, b) {
  for (var c = 0, e; e = a[c]; c++) m(this, e);
  b || this.i()
};
...
function n(a, b) {
  var c = a.getProjection(),
    ...
    h = new google.maps.LatLng(b.getSouthWest().lat(), b.getSouthWest().lng());
  e = c.fromLatLngToDivPixel(e);
  e.x += a.f;
  e.y -= a.f;
  h = c.fromLatLngToDivPixel(h);
  h.x -= a.f;
  h.y += a.f;
  e = c.fromDivPixelToLatLng(e);
  c = c.fromDivPixelToLatLng(h);
  b.extend(e);
  b.extend(c);
  return b
}
...
function l(a) {
  if (a.v)
    for (var b = n(a, new google.maps.LatLngBounds(a.b.getBounds().getSouthWest(), a.b.getBounds().getNorthEast())), c = 0, e; e = a.a[c]; c++) {
      var h = false;
      if (!e.q && b.contains(e.getPosition())) {
        for (var q = 0, j; j = a.l[q]; q++)
          if (!h && j.getCenter() && j.s.contains(e.getPosition())) {
            h = true;
            j.o(e);
            break
          }
...
o.prototype.getCenter = f("d");

function r(a) {
  a.s = n(a.h, new google.maps.LatLngBounds(a.d, a.d))
}
o.prototype.getMap = f("b");

function p(a, b, c) {
  a.h.extend(p, google.maps.OverlayView);
  this.j = b;
  this.aa = c || 0;
  this.p = a;
  this.d = null;
...
p.prototype.onAdd = p.prototype.onAdd;
p.prototype.draw = p.prototype.draw;
p.prototype.onRemove = p.prototype.onRemove;
